...
import com.example.me_mo.notif;
import com.example.me_mo.ReminderTask;
import com.example.me_mo.WaterReminderIntentService;
...
public class NotificationUtils {
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context)
    {
       ...
       NotificationCompat.Action ignoreReminferAction = new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,"No Thanks",
