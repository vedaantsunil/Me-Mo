...
public class mono extends Activity implements AdapterView.OnItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_settings:
                startActivity(new Intent(mono.this, SettingsActivity.class));
                return true;
            default:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(mono.this, LockerService.class));
